...
<!-- Section Sản phẩm thuốc cho trẻ em -->
<section class="section service-2">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                <div class="section-title">
                    <h2>Sản Phẩm Thuốc Kê Đơn</h2>
                    <div class="divider mx-auto my-4"></div>
                    <p>Khám phá các sản phẩm thuốc dành riêng cho trẻ em, được kiểm định chất lượng và an toàn.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="row product-grid">
                    <?php
                    $childrenProducts = getProductsForChildren($page, $itemsPerPage, $minPrice, $maxPrice, $medicineTypes, $userTypes, $sort);
                ...
                <div class="pagination-wrapper text-center mt-4">
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <?php if ($page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?php echo ($page - 1); ?>&min_price=<?php echo $minPrice; ?>&max_price=<?php echo $maxPrice; ?>&sort=<?php echo $sort; ?>">
                            ...
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                    <a class="page-link" href="?page=<?php echo $i; ?>&min_price=<?php echo $minPrice; ?>&max_price=<?php echo $maxPrice; ?>&sort=<?php echo $sort; ?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
...
<!-- Section benefits với background image -->
